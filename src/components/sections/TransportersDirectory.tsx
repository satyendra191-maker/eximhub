...
import { transportToServiceResource } from '@/lib/serviceAdapters'

const resources = transportResources.map(transportToServiceResource)
...
export function TransportersDirectory() {
  ...
  return (
    <section id="transporters" className="scroll-mt-20 py-20 bg-muted/30">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
        ...
        <AnimatePresence mode="wait">
          {filtered.length === 0 ? (
            ...
            >
              <p className="text-lg text-muted-foreground">No transport providers found matching your search.</p>
            </motion.div>
          ) : (
            <motion.div
              initial={{ opacity: 0 }}
