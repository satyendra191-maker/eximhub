...
export function generateCommercialInvoice() {
  downloadHtml(wrapHtml('Commercial Invoice', [
  ...
  ].join('')), 'commercial-invoice.html')
}

export function generatePackingList() {
  downloadHtml(wrapHtml('Packing List', [
  ...
  ].join('')), 'packing-list.html')
}

export function generateProformaInvoice() {
  downloadHtml(wrapHtml('Proforma Invoice', [
  ...
  ].join('')), 'proforma-invoice.html')
}

export function generateBillOfLading() {
  downloadHtml(wrapHtml('Bill of Lading', [
  ...
  ].join('')), 'bill-of-lading.html')
}

export function generateAirWaybill() {
  downloadHtml(wrapHtml('Air Waybill', [
  ...
  ].join('')), 'air-waybill.html')
}

export function generateInsuranceCertificate() {
  downloadHtml(wrapHtml('Marine Insurance Certificate', [
  ...
  ].join('')), 'insurance-certificate.html')
}

export function generateFumigationCertificate() {
  downloadHtml(wrapHtml('Fumigation Certificate', [
  ...
  ].join('')), 'fumigation-certificate.html')
}

export function generateDangerousGoodsDeclaration() {
  downloadHtml(wrapHtml('Dangerous Goods Declaration', [
  ...
  ].join('')), 'dangerous-goods-declaration.html')
}

export function generateCertificateOfOriginChecklist() {
  downloadHtml(wrapHtml('Certificate of Origin Checklist', [
  ...
  ].join('')), 'certificate-of-origin-checklist.html')
}

export function generateHealthSanitaryCertificate() {
  downloadHtml(wrapHtml('Health & Sanitary Certificate', [
  ...
  ].join('')), 'health-sanitary-certificate.html')
}

export function generatePSICertificate() {
  downloadHtml(wrapHtml('Pre-Shipment Inspection Certificate', [
  ...
  ].join('')), 'psi-certificate.html')
}

export function generateHalalCertificate() {
  downloadHtml(wrapHtml('Halal Certificate Application', [
  ...
  ].join('')), 'halal-certificate-application.html')
}

export function generateFDAPriorNoticeChecklist() {
  downloadHtml(wrapHtml('US FDA Prior Notice Checklist', [
  ...
  ].join('')), 'fda-prior-notice-checklist.html')
}

export function generateSafetyDataSheet() {
  downloadHtml(wrapHtml('Safety Data Sheet', [
  ...
  ].join('')), 'safety-data-sheet.html')
}

export function generateEUR1Certificate() {
  downloadHtml(wrapHtml('EUR.1 Movement Certificate', [
  ...
  ].join('')), 'eur1-certificate.html')
}

export function generateSAFTACOO() {
  downloadHtml(wrapHtml('SAFTA Certificate of Origin', [
...
export function generateArabLeagueCOO() {
  downloadHtml(wrapHtml('Arab League COO', [
  ...
  ].join('')), 'arab-league-coo.html')
}

export function generateLCComplianceChecklist() {
  downloadHtml(wrapHtml('LC Compliance Checklist', [
  ...
  ].join('')), 'lc-compliance-checklist.html')
}

export function generateBillOfExchange() {
  downloadHtml(wrapHtml('Bill of Exchange', [
  ...
  ].join('')), 'bill-of-exchange.html')
}

export function generateGSTLUTApplication() {
  downloadHtml(wrapHtml('GST LUT Application', [
  ...
  ].join('')), 'gst-lut-application.html')
}

export function generateRoDTEPDrawbackClaim() {
  downloadHtml(wrapHtml('RoDTEP / Drawback Claim', [
  ...
  ].join('')), 'rodtep-drawback-claim.html')
}

export function generateBRCFIRCDeclaration() {
  downloadHtml(wrapHtml('BRC / FIRC Declaration', [
  ...
  ].join('')), 'brc-firc-declaration.html')
}

export function generateShippingBillChecklist() {
  downloadHtml(wrapHtml('Shipping Bill Checklist', [
  ...
  ].join('')), 'shipping-bill-checklist.html')
}

export function generateExportReadinessChecklist() {
  downloadHtml(wrapHtml('Export Readiness Checklist', [
  ...
  ].join('')), 'export-readiness-checklist.html')
}
